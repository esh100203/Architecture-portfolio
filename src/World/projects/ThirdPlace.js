    ...
    <div class="pp_scroll">
      ...
      <section class="tp_hero">
        ...
        <div class="tp_right_col">
          <img src="assets/projects/thirdplace/thumbnail.png" alt="The Third Place" class="tp_hero_img" />
        </div>
      </section>
      ...
      <div class="tp_bazaar_section">
        ...
        <img src="assets/projects/thirdplace/bazaar-character.png" alt="Bazaar Character" class="tp_bazaar_img" />
      </div>
      ...
      <div class="tp_montage_section">
        <img src="assets/projects/thirdplace/montage-combined.png" alt="Street Montages" class="tp_montage_combined_img" id="tp_montage_combined_img" onload="(function(img){var box=document.querySelector('.tp_montage_white_box');if(box)box.style.height=img.offsetHeight+'px';})(this)" />
        <div class="tp_montage_white_box">
          <img src="assets/projects/thirdplace/dataset.png" alt="Dataset" class="tp_dataset_img" />
        </div>
      </div>

      <!-- Section 4: Site Plan full width -->
      <div class="tp_siteplan_section">
        <img src="assets/projects/thirdplace/site-plan-a.png" alt="Site Plan" class="tp_siteplan_img" />
      </div>

      <!-- Section 5: Section 2 clipped -->
      <div class="tp_siteplan_section" style="padding-top: 56px; overflow: hidden;">
        <img src="assets/projects/thirdplace/section-2.png" alt="Section 2" class="tp_siteplan_img" style="width: calc(67% + 8px);" />
      </div>

      <!-- Section 6: Plan + text + render 4 -->
      <div class="tp_plan_section">
        <img src="assets/projects/thirdplace/plan.png" alt="Plan" class="tp_plan_img" id="tp_plan_img" onload="(function(img){var col=document.querySelector('.tp_plan_right_col');if(col)col.style.height=img.offsetHeight+'px';})(this)" />
        <div class="tp_plan_right_col">
          ...
          <img src="assets/projects/thirdplace/render-4.png" alt="Render 4" class="tp_plan_stack_img" />
        </div>
      </div>
      ...
      <div class="tp_final_viewport">
        <div class="tp_renders_row">
          <img src="assets/projects/thirdplace/render-2.png" alt="Render 2" class="tp_renders_row_img" style="object-position: left bottom;" />
          <img src="assets/projects/thirdplace/render-3.png" alt="Render 3" class="tp_renders_row_img" style="object-position: right bottom;" />
        </div>
        <div class="tp_final_section1">
          <img src="assets/projects/thirdplace/section-1.png" alt="Section 1" class="tp_final_section1_img" />
        </div>
