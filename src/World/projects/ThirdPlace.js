  ...
  return `
    ...
    <div class="pp_scroll">
      ...
      <div class="tp_siteplan_section" style="padding-top: 56px; overflow: hidden;">
        <img loading="lazy" src="assets/projects/thirdplace/section-2.png" alt="Section 2" class="tp_siteplan_img" style="width: calc(67% + 8px);" />
      </div>
      ...
      <div class="tp_final_viewport">
        ...
        <div class="tp_final_section1">
          <img loading="lazy" src="assets/projects/thirdplace/section-1.png" alt="Section 1" class="tp_final_section1_img" />
        </div>
