  ...
  return `
    ...
    <div class="pp_scroll">
      ...
      <section class="in_hero">
        <div class="in_left_col">
          <div class="in_top_block">
          <div class="in_number">05</div>

          <div class="in_meta">
            <div class="in_meta_row">
              <span class="in_meta_label">Architecture Studio</span>
              <span class="in_meta_value">Architecture Dialogue</span>
            </div>
            <div class="in_meta_row">
              <span class="in_meta_label">Location</span>
              <span class="in_meta_value">Bengaluru, Karnataka</span>
            </div>
            <div class="in_meta_row">
              <span class="in_meta_label">Duration</span>
              <span class="in_meta_value">Six Months</span>
            </div>
            <div class="in_meta_row">
      ...
      <section class="in_project_section">
        <div class="in_project_text">
          <div class="in_project_label">
            <span class="in_project_num">01</span>
            <span class="in_project_name">Amara Aneja</span>
          </div>
          <div class="in_context_text">
            <p>Amara Aneja is a residential project in Chennai, Tamil Nadu. During my time, I was heavily involved in the core execution and coordination of the civil work, gaining hands-on experience with Good For Construction (GFC) packages and technical detailing. My primary responsibilities revolved around developing and reviewing comprehensive structural and architectural drawings to ensure flawless on-site execution.</p>
            <p>I worked extensively on fundamental structural components, including the detailed planning of floor plans, sections, and elevations. Beyond core structural elements, I managed door and window schedules, ensuring alignment between architectural openings and structural framing, detailed toilet construction and Reflected Ceiling Plans (RCP), and coordinated the lighting and electrical layouts. Designing and managing the execution of the compound wall provided valuable insights into boundary aesthetics, retaining structures, and foundational civil detailing. Overall, this project significantly sharpened my technical acumen and enhanced my ability to read and execute GFC packages.</p>
          </div>
        </div>
      ...
      <section class="in_project_section">
        <div class="in_project_text">
          <div class="in_project_label">
            <span class="in_project_num">02</span>
            <span class="in_project_name">Amara Sesha</span>
          </div>
          <div class="in_context_text">
            <p>Amara Sesha is a high end residential project in Chennai. During my time working, my responsibilities were primarily centered around managing high-end finishing work and architectural detailing. I actively contributed to the development of the building's premium identity by translating facade finishes and elevation layouts into actionable technical drawings.</p>
            <p>On the upper levels, I took charge of the terrace finishes, managing the wall elevations and specifying resilient flooring materials tailored for exposed outdoor spaces. Overseeing the terrace filling process further provided me with practical insights into waterproofing integration, slope management, and proper drainage execution for landscaped rooftop zones.</p>
          </div>
        </div>
        <div class="in_project_img_wrap">
      ...
      <section class="in_project_section">
        <div class="in_project_text">
          <div class="in_project_label">
            <span class="in_project_num">03</span>
            <span class="in_project_name">SSB Panchasheel</span>
          </div>
          <div class="in_context_text">
            <p>SSB Panchasheel is a residential project in Delhi. For the SSB project, my responsibilities spanned across presentation graphics and technical construction.</p>
            <p>I was tasked with transforming standard architectural layouts into highly polished, visually compelling rendered plans intended specifically for marketing material. I learned how to use visualization tools more dynamically to represent material depth, flooring transitions, and spatial scale in a 2D format.</p>
          </div>
        </div>
        <div class="in_project_img_wrap">
