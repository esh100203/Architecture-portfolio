    ...
    <div class="pp_scroll">
      ...
      <section class="clr_hero">
        ...
        <div class="clr_right_col">
          <img src="assets/projects/citylivingroom/thumbnail.png" alt="City's Living Room" class="clr_hero_img" />
        </div>
      </section>
      ...
      <div class="clr_concepts_row">
        <img src="assets/projects/citylivingroom/architectural-concept-1.png" alt="Architectural Concept 1" class="clr_concept_img clr_concept_primary" />
        <img src="assets/projects/citylivingroom/architectural-concept.png" alt="Architectural Concept" class="clr_concept_img clr_concept_secondary" />
        <img src="assets/projects/citylivingroom/spain-concept.png" alt="Spain Concept" class="clr_concept_img clr_concept_secondary" style="margin-left: 64px; max-height: calc((100vh - 80px) * 0.92);" />
      </div>

      <!-- Render 1 + site condition -->
      <div class="clr_renders_section">
        <img src="assets/projects/citylivingroom/render-1.png" alt="Render 1" class="clr_render_main" id="clr_render1" onload="(function(img){var sc=document.querySelector('.clr_site_condition');if(sc)sc.style.height=img.offsetHeight+'px';})(this)" />
        <div class="clr_renders_stack">
          <img src="assets/projects/citylivingroom/site-condition.png" alt="Site Condition" class="clr_site_condition" />
        </div>
      </div>
      ...
      <div class="clr_plan_section">
        <img src="assets/projects/citylivingroom/plan-2.png" alt="Plan" class="clr_plan_img" onload="(function(img){var r=document.querySelector('.clr_plan_right');if(r)r.style.height=img.offsetHeight+'px';})(this)" />
      ...
      <div class="clr_renders_row2">
        <img src="assets/projects/citylivingroom/render-2.png" alt="Render 2" class="clr_renders_row2_img" />
        <img src="assets/projects/citylivingroom/render-3.png" alt="Render 3" class="clr_renders_row2_img" />
      </div>
